...
def find_similar_artist(artist_name):
    ...
    r = requests.get("http://ws.audioscrobbler.com/2.0/?method=artist.getsimilar&artist="+urllib.parse.quote(artist_name)+"&api_key=8aef36b2e4731be3a1ea47ad992eb984&format=json")
...
def get_artist_song(final_artist):
    ...
    r = requests.get("http://ws.audioscrobbler.com/2.0/?method=artist.gettoptracks&artist="+urllib.parse.quote(final_artist)+"&api_key=8aef36b2e4731be3a1ea47ad992eb984&format=json")
